    ...
    <div className="dashboard-container">
      ...
      <div className="dashboard-layout">
        ...
        <div className="main-content">
          ...
          {(activeTab === 'content' || activeTab === 'social' || activeTab === 'financial') && (
            <div className="coming-soon">
              <div className="coming-soon-icon">🚀</div>
              <h3 className="coming-soon-title">Feature Coming Soon</h3>
              <p className="coming-soon-text">
                {activeTab === 'financial' 
                  ? 'Full financial dashboard with charts and insights'
                  : 'This section will be integrated with your venture context'
                }
              </p>
            </div>
          )}
